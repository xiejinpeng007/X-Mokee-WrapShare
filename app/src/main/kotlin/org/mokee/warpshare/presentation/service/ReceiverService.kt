 ...
 */
package org.mokee.warpshare.presentation.service
...
import org.mokee.warpshare.presentation.PartialWakeLock
...
import org.mokee.warpshare.core.airdrop.ReceivingSession
...
class ReceiverService : Service(), ReceiverListener {
    private val mAirDropManager = ShareManagerModule.mAirDropManager

    private val mDevices: MutableSet<String> = HashSet()
    private val mSessions: MutableMap<String?, ReceivingSession> = HashMap()
    private var mRunning = false
    private var mWakeLock = PartialWakeLock(AppModule.powerManager, TAG)
